        ...
        <div class="col-lg-12">
        	...
        	<div class="card-footer">
        		<div class="user-block">
        			<img class="img-circle img-boardered-sm" src="${path }/dist/img/user1-128x128.jpg " alt="user image">
        			<span class="username">
        		...
        		<div class="card-footer">
        			...
        			</div><button type="submit" class="btn btn-primary delBtn"><i class="fa fa-trash"></i>삭제</button>
        			<script>
